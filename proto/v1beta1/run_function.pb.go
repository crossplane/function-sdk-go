...
const file_v1beta1_run_function_proto_rawDesc = "" +
	"\n" +
	"\x1av1beta1/run_function.proto\x12\x1eapiextensions.fn.proto.v1beta1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xfd\a\n" +
	...
	"\x12required_resources\x18\b \x03(\v2I.apiextensions.fn.proto.v1beta1.RunFunctionRequest.RequiredResourcesEntryR\x11requiredResources\x1al\n" +
	...
	"\x05value\x18\x02 \x01(\v2+.apiextensions.fn.proto.v1beta1.CredentialsR\x05value:\x028\x01\x1ao\n" +
	"\x16RequiredResourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).apiextensions.fn.proto.v1beta1.ResourcesR\x05value:\x028\x01B\b\n" +
	"\x06_inputB\n" +
	"\n" +
	"\b_context\"r\n" +
	"\vCredentials\x12Y\n" +
	"\x0fcredential_data\x18\x01 \x01(\v2..apiextensions.fn.proto.v1beta1.CredentialDataH\x00R\x0ecredentialDataB\b\n" +
	"\x06source\"\x97\x01\n" +
	"\x0eCredentialData\x12L\n" +
	"\x04data\x18\x01 \x03(\v28.apiextensions.fn.proto.v1beta1.CredentialData.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	...
	"\aresults\x18\x03 \x03(\v2&.apiextensions.fn.proto.v1beta1.ResultR\aresults\x126\n" +
	"\acontext\x18\x04 \x01(\v2\x17.google.protobuf.StructH\x00R\acontext\x88\x01\x01\x12P\n" +
	"\frequirements\x18\x05 \x01(\v2,.apiextensions.fn.proto.v1beta1.RequirementsR\frequirements\x12I\n" +
	"\n" +
	...
	"\x03tag\x18\x01 \x01(\tR\x03tag\"\xbd\x03\n" +
	"\fRequirements\x12m\n" +
	"\x0fextra_resources\x18\x01 \x03(\v2@.apiextensions.fn.proto.v1beta1.Requirements.ExtraResourcesEntryB\x02\x18\x01R\x0eextraResources\x12Y\n" +
	"\tresources\x18\x02 \x03(\v2;.apiextensions.fn.proto.v1beta1.Requirements.ResourcesEntryR\tresources\x1as\n" +
	"\x13ExtraResourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12F\n" +
	"\x05value\x18\x02 \x01(\v20.apiextensions.fn.proto.v1beta1.ResourceSelectorR\x05value:\x028\x01\x1an\n" +
	...
	"\x04_ttl\"\x8b\x02\n" +
	"\x05State\x12F\n" +
	"\tcomposite\x18\x01 \x01(\v2(.apiextensions.fn.proto.v1beta1.ResourceR\tcomposite\x12R\n" +
	"\tresources\x18\x02 \x03(\v24.apiextensions.fn.proto.v1beta1.State.ResourcesEntryR\tresources\x1af\n" +
	"\x0eResourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.apiextensions.fn.proto.v1beta1.ResourceR\x05value:\x028\x01\"\xb2\x02\n" +
	"\bResource\x123\n" +
	"\bresource\x18\x01 \x01(\v2\x17.google.protobuf.StructR\bresource\x12n\n" +
	"\x12connection_details\x18\x02 \x03(\v2?.apiextensions.fn.proto.v1beta1.Resource.ConnectionDetailsEntryR\x11connectionDetails\x12;\n" +
	"\x05ready\x18\x03 \x01(\x0e2%.apiextensions.fn.proto.v1beta1.ReadyR\x05ready\x1aD\n" +
	"\x16ConnectionDetailsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\xe0\x01\n" +
	"\x06Result\x12D\n" +
	"\bseverity\x18\x01 \x01(\x0e2(.apiextensions.fn.proto.v1beta1.SeverityR\bseverity\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x1b\n" +
	"\x06reason\x18\x03 \x01(\tH\x00R\x06reason\x88\x01\x01\x12C\n" +
	"\x06target\x18\x04 \x01(\x0e2&.apiextensions.fn.proto.v1beta1.TargetH\x01R\x06target\x88\x01\x01B\t\n" +
	"\a_reasonB\t\n" +
	"\a_target\"\xf2\x01\n" +
	"\tCondition\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12>\n" +
	"\x06status\x18\x02 \x01(\x0e2&.apiextensions.fn.proto.v1beta1.StatusR\x06status\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x12\x1d\n" +
	"\amessage\x18\x04 \x01(\tH\x00R\amessage\x88\x01\x01\x12C\n" +
